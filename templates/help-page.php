...
<style>
        ...
        <div class="amber-help-page">
            ...
            <header class="ahp-header">
                ...
                <span class="version">v1.27.10 · Bristol &amp; District Intergroup</span>
            </header>
                ...
                <main class="ahp-main">
                    ...
                    <section id="ahp-member-create">
                        ...
                        <table class="field-table">
                            ...
                            <tr><td><span class="field-name">Personal email</span></td><td>Private. Visible with <code>scrutiny_view_personal_data</code>; editable with <code>scrutiny_edit_personal_data</code>. Used for sending correspondence. Must be the member's own address — an <code>@aa-bristol.org</code> address is refused.</td></tr>
                    ...
                    <section id="ahp-member-contacts">
                        ...
                        <div class="callout warning"><span class="callout-icon">⚠️</span><div><strong>Not an intergroup address.</strong> Saving is refused if <strong>Personal Email</strong> contains <code>aa-bristol.org</code>. Those addresses forward to whoever currently holds the position, so mail sent to one reaches the intergroup rather than the member — and stops reaching them altogether once they rotate out. Enter the member's own address, or leave the field empty.</div></div>
                    </section>
