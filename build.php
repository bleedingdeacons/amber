...
/**
 * Build Script for Amber WordPress Plugin
 *
...
class PluginBuilder
{
    ...
    private string $pluginName = 'amber';
    ...
    {
        $mainFile = $this->pluginDir . DIRECTORY_SEPARATOR . 'amber.php';
     ...
     * Create ZIP archive
     */
    private function createZip(string $archiveName, array $excludes): void
    {
...
Amber WordPress Plugin Build Script
====================================
Platform: {$platform}
...
Note:
  Amber is a companion plugin to Unity. Make sure Unity is installed
  and activated before activating Amber.
