...
class Plugin
{
    ...
    public static function init(Container $unityContainer): void
    {
        ...
        if (is_admin()) {
            ...
            add_action('admin_menu', [self::class, 'registerHelpMenu'], 999);
     ...
     * preserving all original styles scoped under .amber-help-page.
     */
                ...
                <main class="ahp-main">
                    ...
                    <section id="ahp-member-create">
                        ...
                        <ol class="steps">
                            ...
                            <li>Enter their <strong>Personal Email</strong> and <strong>Mobile Number</strong>. These are stored securely and only visible to admin users.</li>
                        ...
                        <table class="field-table">
                            ...
                            <tr><td><span class="field-name">Personal email</span></td><td>Private. Admin-only. Used for sending correspondence.</td></tr>
                            <tr><td><span class="field-name">Mobile number</span></td><td>Private. Admin-only.</td></tr>
                            </tbody>
                        </table>
                    </section>
                    ...
                    <section id="ahp-member-contacts">
                        ...
                        <div class="callout info"><span class="callout-icon">💡</span><div>Personal contact details are never shown publicly. They are logged by Scrutiny every time they are accessed, in line with GDPR requirements.</div></div>
                    </section>
